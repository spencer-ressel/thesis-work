...
#demo_start_time = '2006-12-11'
#demo_end_time = '2006-12-11'
#demo_start_time = '2006-01-11'
#demo_end_time = '2006-01-11'
#demo_start_time = '2005-03-21'
#demo_end_time = '2005-03-21'
#demo_start_time = '2018-01-01'
#demo_end_time = '2018-01-01'
...
#eval_era5 = xarray.load_dataset(f"../neuralgcm/neuralgcm/input/era5_init_{demo_start_time}.nc")
...
# timedelta = np.timedelta64(30, 'm') * inner_steps
...
mean_state_correction_state = final_state.state - initial_state.state
mean_state_correction_memory = final_state.memory - initial_state.memory
...
for day in np.arange(0, n_days, 1):
    ...
    corrected_initial_state = initial_state.replace(state = final_state.state - mean_state_correction_state)
...
experiment_parameters = {
    'experiment_name': 'memory_replacement_test_1',
    'description': 'This test uses the 2.8 deg model and 24-hr timesteps with the additional of updating the model memory, not just the model state.',
