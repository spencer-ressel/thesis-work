...
experiment_parameters = {
    'experiment_name': 'perturbation_test_1',
    'description': 'This test uses the 2.8 deg model and 1-hr timesteps along with the model.advance function. The initial condition has been modified by the addition of a perturbation.',
